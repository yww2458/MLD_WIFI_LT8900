...
//tengh
typedef _Bool  bit;
typedef @near unsigned long  uu32;
typedef @near unsigned short uu16;
typedef @near unsigned char  uu8;
typedef @near signed long  ss32;
typedef @near signed short ss16;
typedef @near signed char  ss8;
