  ...
  71  0018 82            	dc.b	130
  73  0019 00            	dc.b	page(f_EXTI_PORTB_IRQHandler)
  74  001a 0000          	dc.w	f_EXTI_PORTB_IRQHandler
  75  001c 82            	dc.b	130
 ...
 109  003d 00            	dc.b	page(f_TIM2_isr)
 110  003e 0000          	dc.w	f_TIM2_isr
 ...
 137  0059 00            	dc.b	page(f_UART2_Send_IRQHandler)
 138  005a 0000          	dc.w	f_UART2_Send_IRQHandler
 139  005c 82            	dc.b	130
 141  005d 00            	dc.b	page(f_UART2_Recv_IRQHandler)
 142  005e 0000          	dc.w	f_UART2_Recv_IRQHandler
 ...
 149  0065 00            	dc.b	page(f_TIM4_isr)
 150  0066 0000          	dc.w	f_TIM4_isr
 ...
 228                     	xref	f_UART2_Send_IRQHandler
 229                     	xref	f_UART2_Recv_IRQHandler
 230                     	xref	f_TIM4_isr
 231                     	xref	__stext
 232                     	xdef	f_NonHandledInterrupt
 251                     	end
